    ...
    _init: function () {
        ...
        function completeInit(sm) {
            if (sm) {
                ...
                var names = null;
                if ($.isArray(self.options.s2.audio))
                    names = self.options.s2.audio;
                else
                    names = [self.options.s2.audio];
                var urls = [ ];
            ...
            self.sentenceMD5 = csv_url_encode(self.options.s2.html ? self.options.s2.html : (self.options.s2.audio ? self.options.s2.audio+'' : (self.options.s2+'')));
